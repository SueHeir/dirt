...
def plot(dirt, lammps):
    ...
    axa.plot(gam, [r["a_up_pred"] for r in d], "k-", label="theory")
    axa.plot(gam, [r["a_down_pred"] for r in d], "k-")
    ...
    axb.plot(gam, [r["alpha_down_pred"] for r in d], "k-", label="theory")
    axb.plot(gam, [r["alpha_up_pred"] for r in d], "k-")
