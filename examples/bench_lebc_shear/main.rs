...
//!
//! Tier-1 of the DEM calibration campaign: a triperiodic box of glass beads is
//! sheared at a constant rate γ̇ via the native Lees–Edwards (triclinic-box)
...
//! `Φ` to `<output_dir>/data/lebc_shear_results.csv`. `sweep.py` time-averages the
//! steady window, forms `I, μ, Φ`, validates against kinetic theory, and fits μ(I).
//!
//! ```bash
