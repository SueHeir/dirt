...
*Measured mass and momentum conservation errors are plotted with the same run's
fracture/contact diagnostics through the peri-to-DEM transition. Latest
regenerated run: PASS, with surviving bonds below the checked fracture limit,
peak damage at 1.000, and active DEM contacts above the required count.*
